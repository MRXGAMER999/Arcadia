...
/**
 * Use case for getting sent (outgoing) friend requests.
 */
class GetSentRequestsUseCase(
    ...
    /**
     * Gets realtime updates of outgoing friend requests.
     * 
     * @return Flow emitting RequestState with list of sent requests
     */
    operator fun invoke(): Flow<RequestState<List<FriendRequest>>> {
        ...
        return friendsRepository.getOutgoingRequestsRealtime(userId)
    }
}
