...
/**
 * A single game recommendation with confidence score, reason, badges, and metadata.
 * Enhanced with developer, year, badges, and similar games for better sorting and display.
 */
data class GameRecommendation(
    val name: String,
    val confidence: Int = 50, // 1-100, higher = better match
    val reason: String? = null, // Detailed 3-5 sentence explanation
    val badges: List<String> = emptyList(), // AI-generated meaningful tags like "FromSoft Devotee", "97 Metacritic"
    val developer: String? = null, // Developer studio name for sorting/display
    val year: Int? = null, // Release year for secondary sorting
    val similarTo: List<String> = emptyList() // Games from user's library this is similar to
) {
    companion object {
        /**
        ...
        /**
         * Create a recommendation from a tier string (V6 format with full metadata + badges).
         ...
         * @param why Optional detailed explanation for the match (3-5 sentences)
         * @param badges Optional list of meaningful tags generated by AI
         * @param developer Optional developer studio name
         * @param year Optional release year
         * @param similarTo Optional list of similar games from user library
         */
        fun fromTierString(
            name: String, 
            tier: String, 
            ...
            return GameRecommendation(name, confidence, why, badges, developer, year, similarTo)
        }
